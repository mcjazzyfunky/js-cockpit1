...
import { ITheme, classNamesFunction, customizable, getTheme } from 'office-ui-fabric-react'
...
function defineStyle2<S extends Styles>(getStyles: (theme: ITheme, props?: any) => S): Return<S>
function defineStyle2<S extends Styles>(styles: S): Return<S>
function defineStyle2(arg: any): any {
